...
func (m *MockMessageSender) SendCurrencyKeyboard(userID int64, text string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendCurrencyKeyboard", userID, text)
	ret0, _ := ret[0].(error)
	return ret0
}

// SendCurrencyKeyboard indicates an expected call of SendCurrencyKeyboard.
func (mr *MockMessageSenderMockRecorder) SendCurrencyKeyboard(userID, text interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendCurrencyKeyboard", reflect.TypeOf((*MockMessageSender)(nil).SendCurrencyKeyboard), userID, text)
}
...
func (m *MockMessageSender) SendRangeKeyboard(userID int64, text string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendRangeKeyboard", userID, text)
	ret0, _ := ret[0].(error)
	return ret0
}

// SendRangeKeyboard indicates an expected call of SendRangeKeyboard.
func (mr *MockMessageSenderMockRecorder) SendRangeKeyboard(userID, text interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendRangeKeyboard", reflect.TypeOf((*MockMessageSender)(nil).SendRangeKeyboard), userID, text)
}
